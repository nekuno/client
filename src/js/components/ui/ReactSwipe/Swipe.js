...
(function(root, factory) {
    ...
    return function Swipe(container, options) {
        ...
        var browser = {
            ...
            mstouch: window.navigator && window.navigator.msPointerEnabled,//ADDED
        ...
        var isScrolling;
        var moved = false;
        // setup event capturing //MODIFIED
        var events = {
            ...
            clicked: function(event) {
                //execute function
                options.clicking && options.clicking();
            },
            end: function(event) {
                // measure duration
                ...
                // kill touchmove and touchend event listeners until touchstart called again MODIFIED
