...
class LinkImageService {
    ...
    getUrlHash = function(url) {
        const md5 = this.md5(url);
        const md5Cropped = md5.substr(md5.length - 10);
        const hash = md5Cropped.toString().substr(0, 4) + '/' + md5Cropped.toString().substr(4, 4) + '/' +  md5Cropped.toString().substr(8);
    ...
    utf8Encode = function utf8_encode (argString) {
