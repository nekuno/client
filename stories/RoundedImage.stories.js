...
storiesOf('RoundedImage', module)
    ...
    .add('with medium image', () => (
        <RoundedImage url="http://via.placeholder.com/100x100" size="medium" onClickHandler={action('clicked')}/>
    ))
    ...
    .add('with x-small image', () => (
        <RoundedImage url="http://via.placeholder.com/40x40" size="x-small" onClickHandler={action('clicked')}/>
    ))
    .add('set of images', () => (
        <div>
            <RoundedImage url="http://via.placeholder.com/40x40" size="x-small" onClickHandler={action('clicked')}/>
